    ...
    <div className="py-10 bg-black text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        {clubs.map((club, index) => (
          <div
            key={index}
            className="bg-gray-900 shadow-md rounded-lg overflow-hidden cursor-pointer hover:scale-105 transition-transform"
      ...
      {selectedClub && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center">
          <div className="bg-gray-900 rounded-lg p-6 shadow-lg w-4/5 max-w-md text-white">
            <button
            ...
            <p className="text-gray-400">Points : {selectedClub.stats.points}/match</p>
            <p className="text-gray-400">Rebonds : {selectedClub.stats.rebounds}/match</p>
            <p className="text-gray-400">Passes : {selectedClub.stats.assists}/match</p>
          </div>
        </div>
      )}
    </div>
